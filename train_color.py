...
def train(args):
    ...
    if args.continue_train:
        ...
        # model_path = 'checkpoints//drrw_no_fc_color/model_501.pth'
...
def train_print():
    train_noise_dict = {"Jpeg": 30, "GaussianBlur": 1.5, "GaussianNoise": 0.15, "SaltPepperNoise": 0.15,
    ...
    parser.add_argument("--train_name", type=str, default="color")
    ...
    parser.add_argument('--num_epoch', type=int, default=105)
